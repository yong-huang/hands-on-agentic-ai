# qa · AI Agent 31 问（一问一实证，全部可跑）

> 以 **31 个高频问题**为纲：每个问题对应一个能跑通的最小项目，做完即
> "能讲+能写"。三条问题主线贯穿：**ReAct 循环能手写** · **记忆系统+RAG
> 能讲清** · **系统设计能画架构图**。
> 语言 Python 3.10+；LLM 走本地 Ollama（qwen3.8，OpenAI 兼容接口），全部
> 支持 `MOCK=1` 离线模式。完整题单、AI 提示词与踩坑日志见
